  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <KeyboardAvoidingView
        ...
        className="flex-1 bg-indigo-900 justify-center px-6"
      >
        <View className="items-center mb-12">
          <View className="w-40 h-40 bg-yellow-400 rounded-full items-center justify-center border-8 border-yellow-200 shadow-2xl mb-6">
            <Text className="text-5xl font-black text-indigo-900 shadow-sm">
              FB
            </Text>
          </View>
          <Text
            className="text-6xl font-black text-white text-center mb-2"
            style={{
          ...
          <Text className="text-xl text-indigo-200 font-black tracking-widest text-center">
            MINI DRINKING GAMES
          </Text>
        </View>
        ...
        <View className="bg-white/10 p-6 rounded-[40px] border-4 border-white/20">
          {mode === "home" ? (
            <View>
              ...
              />
              <Text className="text-white text-center text-xl font-black my-2 opacity-70">
                OR
              </Text>
              <PartyButton
                title="JOIN GAME"
            ...
            <View>
              <TextInput
                className="bg-white/95 rounded-3xl px-6 py-5 text-4xl font-black text-center text-indigo-900 mb-6"
                placeholder="NAME"
